import { Users, Trophy, Video, Gamepad2, Menu, Home, Layout, Settings, LogIn, LayoutDashboard, LogOut, User, Bell, Search, X } from "lucide-react";
...
export default function Welcome({
    ...
    const Index = () => {
        ...
        const menuItems = [
            ...
            { icon: LogIn, label: "Login/Sign-up", path: "/login" },
            
          ];
          const menulogedinItems = [
            
            { icon: Home, label: "Home", path: "" },
            { icon: LayoutDashboard, label: "Dashboard", path: "/dashboard" },
            { icon: LogOut, label: "Dashboard", path: "logout" },
            ...
            <div className="flex items-center gap-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center gap-2 p-2 hover:bg-gray-800 rounded-lg transition-colors">
                  ...
                  <span className="hidden lg:block text-sm text-gray-300">John Doe</span>
                </DropdownMenuTrigger>
